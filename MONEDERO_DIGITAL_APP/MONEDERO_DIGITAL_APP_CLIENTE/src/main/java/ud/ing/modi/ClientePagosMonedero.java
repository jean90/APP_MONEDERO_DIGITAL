...
public class ClientePagosMonedero 
{
    ...
    public String pagoCompra(String codMonedero, String nickCliente, String codTienda, String codCompra, String valorCompra){
        try{
            ...
            System.out.println("Respuesta corta: "+rta.substring(0,1));

            if (rta.substring(0,2).equals("OK")) {
                rta=pago.pagarCompra(codMonedero, codTienda, codCompra, valorCompra, nickCliente);
