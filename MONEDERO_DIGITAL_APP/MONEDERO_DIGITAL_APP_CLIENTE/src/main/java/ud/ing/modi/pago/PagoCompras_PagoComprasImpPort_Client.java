...
public final class PagoCompras_PagoComprasImpPort_Client {
    ...
    public static void main(String args[]) throws Exception {
        ...
        java.lang.String _pagarCompra_codPago = "";
        java.util.List<java.lang.String> _pagarCompra__return = port.pagarCompra(_pagarCompra_codCompra, _pagarCompra_token, _pagarCompra_codPago);
