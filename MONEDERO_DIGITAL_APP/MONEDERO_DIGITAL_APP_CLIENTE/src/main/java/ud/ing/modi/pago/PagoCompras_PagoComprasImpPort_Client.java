...
public final class PagoCompras_PagoComprasImpPort_Client {
    ...
    public static void main(String args[]) throws Exception {
        ...
        java.lang.String _pagarCompra_token = "";
        java.lang.String _pagarCompra_codMonTienda = "";
        java.util.List<java.lang.String> _pagarCompra__return = port.pagarCompra(_pagarCompra_codCompra, _pagarCompra_token, _pagarCompra_codMonTienda);
        ...
        java.lang.String _validarDatosCompra_codTienda = "";
        java.lang.String _validarDatosCompra_codCompra = "";
        java.lang.String _validarDatosCompra_valorCompra = "";
        java.util.List<java.lang.String> _validarDatosCompra__return = port.validarDatosCompra(_validarDatosCompra_codMonedero, _validarDatosCompra_nickCliente, _validarDatosCompra_codTienda, _validarDatosCompra_codCompra, _validarDatosCompra_valorCompra);
